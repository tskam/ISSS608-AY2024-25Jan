...
-   Discovering State of Learning with [PISA 2022](https://www.oecd.org/pisa/data/2022database/). Please refer to [Research and Innovation in PISA](https://www.oecd.org/pisa/innovation/) to get more ideas.
-   Be Weatherwise or Otherwise! Visualising and analysing historical weather data from [Meteorological Service Singapore](http://www.weather.gov.sg/home/). Please refer to [Impact Of Climate Change In Singapore](https://www.nccs.gov.sg/singapores-climate-action/impact-of-climate-change-in-singapore/)
-   Discovering State of Economic with open Government Data and [Nowcasting](https://en.wikipedia.org/wiki/Nowcasting_(economics)) methods. This [link](https://zindi.africa/competitions/rmb-monthly-mini-challenge-1-nowcast-april) provides useful reference.
-   Who Gets What? Discovering G2B network from [GeBIZ](https://beta.data.gov.sg/collections/460/view).
...
-   ~~Uploading project poster on eLearn by **27th March 2024 at 11:59pm (mid-night)**~~.
-   Poster presentation: ~~**30th March 2024, 9:00am-11:00am**~~ **6th April 2024 2:400pm**
-   Submission of final application, user guide, project poster and artifacts: **31st March 2024 by 11:59pm (mid-night)**
...
Each project team are required to create the project website by using [Quarto](https://quarto.org/docs/websites/). It will be disseminated by using webserver such as [Netfity](https://www.netlify.com/).
...
Students are required to update their project websites with all the details including the final application, user guide and poster by **31st March 2024**.
